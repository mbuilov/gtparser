...
int main(int argc, char *argv[])
{
	...
	TF(2, "t\0\0\0",  do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned, x, r); TR(r);} while (0));
	TF(2, "t\0\0z",   do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned, x, r); TR(r);} while (0));
	TF(2, "t\0z\0",   do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned, x, r); TR(r);} while (0));
	TF(2, "t\0zz",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned, x, r); TR(r);} while (0));
	TF(3, "tz\0\0",   do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned, x, r); TR(r);} while (0));
	TF(3, "tz\0z",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned, x, r); TR(r);} while (0));
	TF(4, "tzz\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned, x, r); TR(r);} while (0));
	TF(1, "tzzz",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned, x, r); TR(!r);} while (0));
	/* */
	...
	TF64(2, "i\0\0\0\0\0\0\0",  do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0\0\0\0z",   do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0\0\0z\0",   do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0\0\0zz",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0\0z\0\0",   do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0\0z\0z",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0\0zz\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0\0zzz",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0t\0\0\0",   do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0t\0\0z",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0t\0z\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0t\0zz",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0tz\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0tz\0z",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0tzz\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0\0tzzz",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0z\0\0\0\0",   do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0z\0\0\0z",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0z\0\0z\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0z\0\0zz",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0z\0z\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0z\0z\0z",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0z\0zz\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0z\0zzz",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0zt\0\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0zt\0\0z",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0zt\0z\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0zt\0zz",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0ztz\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0ztz\0z",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0ztzz\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0\0ztzzz",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0\0\0\0\0",   do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0\0\0\0z",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0\0\0z\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0\0\0zz",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0\0z\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0\0z\0z",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0\0zz\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0\0zzz",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0t\0\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0t\0\0z",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0t\0z\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0t\0zz",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0tz\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0tz\0z",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0tzz\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0k\0tzzz",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kz\0\0\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kz\0\0\0z",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kz\0\0z\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kz\0\0zz",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kz\0z\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kz\0z\0z",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kz\0zz\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kz\0zzz",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kzt\0\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kzt\0\0z",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kzt\0z\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kzt\0zz",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kztz\0\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kztz\0z",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kztzz\0",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(2, "i\0kztzzz",        do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0\0\0\0\0",   do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0\0\0\0z",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0\0\0z\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0\0\0zz",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0\0z\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0\0z\0z",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0\0zz\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0\0zzz",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0t\0\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0t\0\0z",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0t\0z\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0t\0zz",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0tz\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0tz\0z",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0tzz\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0\0tzzz",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0z\0\0\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0z\0\0\0z",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0z\0\0z\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0z\0\0zz",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0z\0z\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0z\0z\0z",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0z\0zz\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0z\0zzz",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0zt\0\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0zt\0\0z",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0zt\0z\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0zt\0zz",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0ztz\0\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0ztz\0z",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0ztzz\0",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(3, "im\0ztzzz",        do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0\0\0\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0\0\0\0z",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0\0\0z\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0\0\0zz",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0\0z\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0\0z\0z",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0\0zz\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0\0zzz",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0t\0\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0t\0\0z",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0t\0z\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0t\0zz",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0tz\0\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0tz\0z",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0tzz\0",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(4, "imk\0tzzz",        do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(5, "imkz\0\0\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(5, "imkz\0\0\0z",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(5, "imkz\0\0z\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(5, "imkz\0\0zz",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(5, "imkz\0z\0\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(5, "imkz\0z\0z",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(5, "imkz\0zz\0",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(5, "imkz\0zzz",        do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(6, "imkzt\0\0\0",      do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(6, "imkzt\0\0z",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(6, "imkzt\0z\0",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(6, "imkzt\0zz",        do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(7, "imkztz\0\0",       do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(7, "imkztz\0z",        do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(8, "imkztzz\0",        do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64(1, "imkztzzz",         do {int r; GT_UINT_CONTAINS_ZERO(char, unsigned INT64_TYPE, x64, r); TR(!r);} while (0));
	/* */
	...
	TFW(2, L"t\0\0\0",  do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned, x, r); TR(r);} while (0));
	TFW(2, L"t\0\0z",   do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned, x, r); TR(r);} while (0));
	TFW(2, L"t\0z\0",   do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned, x, r); TR(r);} while (0));
	TFW(2, L"t\0zz",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned, x, r); TR(r);} while (0));
	TFW(3, L"tz\0\0",   do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned, x, r); TR(r);} while (0));
	TFW(3, L"tz\0z",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned, x, r); TR(r);} while (0));
	TFW(4, L"tzz\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned, x, r); TR(r);} while (0));
	TFW(1, L"tzzz",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned, x, r); TR(!r);} while (0));
	/* */
	...
	TF64W(2, L"i\0\0\0\0\0\0\0",  do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0\0\0\0z",   do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0\0\0z\0",   do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0\0\0zz",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0\0z\0\0",   do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0\0z\0z",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0\0zz\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0\0zzz",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0t\0\0\0",   do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0t\0\0z",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0t\0z\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0t\0zz",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0tz\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0tz\0z",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0tzz\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0\0tzzz",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0z\0\0\0\0",   do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0z\0\0\0z",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0z\0\0z\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0z\0\0zz",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0z\0z\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0z\0z\0z",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0z\0zz\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0z\0zzz",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0zt\0\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0zt\0\0z",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0zt\0z\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0zt\0zz",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0ztz\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0ztz\0z",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0ztzz\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0\0ztzzz",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0\0\0\0\0",   do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0\0\0\0z",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0\0\0z\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0\0\0zz",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0\0z\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0\0z\0z",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0\0zz\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0\0zzz",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0t\0\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0t\0\0z",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0t\0z\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0t\0zz",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0tz\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0tz\0z",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0tzz\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0k\0tzzz",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kz\0\0\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kz\0\0\0z",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kz\0\0z\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kz\0\0zz",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kz\0z\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kz\0z\0z",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kz\0zz\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kz\0zzz",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kzt\0\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kzt\0\0z",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kzt\0z\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kzt\0zz",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kztz\0\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kztz\0z",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kztzz\0",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(2, L"i\0kztzzz",        do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0\0\0\0\0",   do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0\0\0\0z",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0\0\0z\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0\0\0zz",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0\0z\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0\0z\0z",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0\0zz\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0\0zzz",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0t\0\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0t\0\0z",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0t\0z\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0t\0zz",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0tz\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0tz\0z",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0tzz\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0\0tzzz",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0z\0\0\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0z\0\0\0z",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0z\0\0z\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0z\0\0zz",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0z\0z\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0z\0z\0z",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0z\0zz\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0z\0zzz",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0zt\0\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0zt\0\0z",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0zt\0z\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0zt\0zz",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0ztz\0\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0ztz\0z",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0ztzz\0",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(3, L"im\0ztzzz",        do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0\0\0\0\0",    do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0\0\0\0z",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0\0\0z\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0\0\0zz",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0\0z\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0\0z\0z",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0\0zz\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0\0zzz",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0t\0\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0t\0\0z",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0t\0z\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0t\0zz",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0tz\0\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0tz\0z",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0tzz\0",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(4, L"imk\0tzzz",        do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(5, L"imkz\0\0\0\0",     do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(5, L"imkz\0\0\0z",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(5, L"imkz\0\0z\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(5, L"imkz\0\0zz",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(5, L"imkz\0z\0\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(5, L"imkz\0z\0z",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(5, L"imkz\0zz\0",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(5, L"imkz\0zzz",        do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(6, L"imkzt\0\0\0",      do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(6, L"imkzt\0\0z",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(6, L"imkzt\0z\0",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(6, L"imkzt\0zz",        do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(7, L"imkztz\0\0",       do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(7, L"imkztz\0z",        do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(8, L"imkztzz\0",        do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(r);} while (0));
	TF64W(1, L"imkztzzz",         do {int r; GT_UINT_CONTAINS_ZERO(wchar_t, unsigned INT64_TYPE, x64, r); TR(!r);} while (0));
